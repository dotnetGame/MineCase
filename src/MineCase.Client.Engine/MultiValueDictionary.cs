...
namespace System.Collections.Generic
{
        ...
        IReadOnlyDictionary<TKey, IReadOnlyCollection<TValue>>
    {
        ...
        ** Constructors
        ...
        {
            if (capacity < 0)
                throw new ArgumentOutOfRangeException("capacity", MineCase.Engine.Properties.Resources.ArgumentOutOfRange_NeedNonNegNum);
        ...
        ** Static Factories
            ...
            where TValueCollection : ICollection<TValue>, new()
        {
            if (new TValueCollection().IsReadOnly)
                throw new InvalidOperationException(MineCase.Engine.Properties.Resources.Create_TValueCollectionReadOnly);
        ...
        ** Members implemented from IReadOnlyDictionary<TKey, IReadOnlyCollection<TValue>>
            ...
            IEnumerator<KeyValuePair<TKey, IReadOnlyCollection<TValue>>>
        {
                ...
                get
                {
                    switch (state)
                    {
                        case EnumerationState.BeforeFirst:
                            throw new InvalidOperationException((MineCase.Engine.Properties.Resources.InvalidOperation_EnumNotStarted));
                        case EnumerationState.AfterLast:
                            throw new InvalidOperationException((MineCase.Engine.Properties.Resources.InvalidOperation_EnumEnded));
                        default:
                            return current;
                    }
                }
            ...
            public bool MoveNext()
            {
                ...
                {
                    throw new InvalidOperationException(MineCase.Engine.Properties.Resources.InvalidOperation_EnumFailedVersion);
                }
            ...
            IReadOnlyCollection<TValue>
        {
            ...
            ** Shared API
            ...
            public void CopyTo(TValue[] array, int arrayIndex)
            {
                ...
                if (arrayIndex < 0)
                    throw new ArgumentOutOfRangeException("arrayIndex", MineCase.Engine.Properties.Resources.ArgumentOutOfRange_NeedNonNegNum);
                if (arrayIndex > array.Length)
                    throw new ArgumentOutOfRangeException("arrayIndex", MineCase.Engine.Properties.Resources.ArgumentOutOfRange_Index);
                if (array.Length - arrayIndex < collection.Count)
                    throw new ArgumentException(MineCase.Engine.Properties.Resources.CopyTo_ArgumentsTooSmall, "arrayIndex");
            ...
            ** Public-Facing API
            ...
            {
                throw new NotSupportedException(MineCase.Engine.Properties.Resources.ReadOnly_Modification);
            }
