...
namespace MineCase.Nbt
{
    ...
    public enum NbtTagType : byte
    {
        ...
        /// <summary>
        /// A length-prefixed array of signed longs (<see cref="T:long[]"/>).
        /// The prefix is a signed long (thus 8 bytes, <see cref="long"/>) and indicates the number of 8 byte integers.
        /// </summary>
